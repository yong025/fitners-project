        ...
        <div class="slider-item js-fullheight">
            ...
            <div class="container-fluid p-0">
                <div class="row d-md-flex no-gutters slider-text align-items-center justify-content-end" data-scrollax-parent="true">
                    <img class="one-third order-md-last img-fluid" src="resources/images/aaaa.jpg" alt="">
                    <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                        <div class="text">

                            <div class="horizontal">
                                <h1 class="mb-4 mt-3">FITNERS </h1>
                                <p class="mb-4">가격 역경매를 통한 자유로운 퍼스널 트레이닝 매칭 서비스.</p>

                                <span><a href="#" class="btn-custom">경매 시작</a></span>
                                <span><a href="#" class="btn-custom">경매 시작할까말까</a></span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="slider-item js-fullheight">
            ...
            <div class="container-fluid p-0">
                <div class="row d-flex no-gutters slider-text align-items-center justify-content-end" data-scrollax-parent="true">
                    <img class="one-third order-md-last img-fluid" src="resources/images/bg11.jpg" alt="">
                    <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                        <div class="text">
                            <div class="horizontal">
                                <h1 class="mb-4 mt-3">Self Managemant</h1>
                                <p class="mb-4">셀프 매니지먼트를 통한 개인 운동관리 시스템.</p>

                                <p><a href="#" class="btn-custom">관리하기</a></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container-fluid p-0">
                <div class="row d-flex no-gutters slider-text align-items-center justify-content-end" data-scrollax-parent="true">
                    ...
                    <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                        <div class="text">
                            <div class="horizontal">
                                <h1 class="mb-4 mt-3">FreeBoard</h1>
                                <p class="mb-4">자유로운 글 작성.</p>

                                <p><a href="#" class="btn-custom">자유게시판 가기</a></p>
                            </div>
                        </div>
                    </div>
                </div>
...
<section class="ftco-section ftco-no-pt ftco-no-pb">
    <div class="container text-center">
        <div class="about">
            <h1>About</h1>
            <span><a href="/about.jsp" class="btn-customA">Read More</a></span>
        </div>
...
<!--    		<div class="row">-->
<!--    			<div class="col-md-5">-->
<!--    				<img src="images/dumbel.png" class="img-fluid2" alt="">-->
<!--    			</div>-->
<!--    			<div class="col-md-6">-->
<!--    				<div class="heading-section heading-section-white">-->

<!--	            <h2 class="mb-3">이런 펀딩 또 없다.</h2>-->
<!--	          </div>-->
...
<!--						</div>-->
<!--						<div class="text-deal">-->
<!--							<h2><a href="#">극혐 덤벨</a></h2>-->
<!--							<p class="price"><span class="mr-2 price-dc">$120.00</span><span class="price-sale">$80.00</span></p>-->
<!--							<ul class="thumb-deal d-flex mt-4">-->
<!--								<li class="img" style="background-image: url(images/dumbel.png);"></li>-->
<!--								<li class="img" style="background-image: url(images/dumbel.png);"></li>-->
<!--								<li class="img" style="background-image: url(images/dumbel.png);"></li>-->
<!--							</ul>-->
<!--						</div>-->
